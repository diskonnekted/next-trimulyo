            ...
            <div className="container mx-auto px-4 space-y-8">
                    ...
                    <Card className="md:col-span-2 lg:col-span-1">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-3">
                                Data kontrasepsi/KB adalah informasi penting dalam data kependudukan yang menunjukkan
                                penggunaan kontrasepsi berdasarkan kelompok produktif.
                            </p>
                            <div className="space-y-2 text-sm">
                                <div className="flex items-start gap-2">
                                    <div className="w-2 h-2 rounded-full bg-pink-600 mt-2 flex-shrink-0" />
                                    <p>Menunjukkan pola kontrasepsi berdasarkan </p>
                                </div>
                                <div className="flex items-start gap-2">
                                    <div className="w-2 h-2 rounded-full bg-pink-600 mt-2 flex-shrink-0" />
                                    <p>Digunakan untuk perencanaan KB</p>
                                </div>
                                <div className="flex items-start gap-2">
                                    <div className="w-2 h-2 rounded-full bg-pink-600 mt-2 flex-shrink-0" />
                                    <p>Menunjang program keluarga</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>

                    {/* Major Contraception Types & Others */}
                    <Card className="md:col-span-1">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                <TrendingUp className="h-5 w-5 text-orange-600" />
                                Kontrasepsi Terbesar
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-3">
                                Menampilkan 3 kelompok dengan pengguna kontrasepsi terbesar dan kelompok lainnya.
                            </p>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <Card className="bg-gradient-to-br from-pink-50 to-rose-50 border-pink-200">
                        <CardHeader>
                            <CardTitle className="text-pink-700">Program KB</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-3">
                                Program Keluarga Berencana untuk keluarga sejahtera
                            </p>
                    ...
                    <Card className="bg-gradient-to-br from-orange-50 to-amber-50 border-orange-200">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-3">
                                Program kesehatan reproduksi dan keluarga
                            </p>
                            <ul className="space-y-1 text-sm">
                                <li>• Konseling reproduksi</li>
