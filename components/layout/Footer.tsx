...
export function Footer() {
    ...
    const quickLinks = [
        ...
        { href: "/lapak", label: "Padi Trimulyo" },
    ...
    const socialLinks = [
        ...
        {
            href: "https://www.instagram.com/kalurahantrimulyo/",
            icon: siInstagram,
            label: "Instagram",
            color: "#FF0069",
        },
        { href: "#", icon: siYoutube, label: "YouTube", color: "#FF0000" },
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-white">Kalurahan Trimulyo</h3>
                                <p className="text-xs text-blue-100">Kabupaten Sleman, DIY</p>
                            </div>
                        </div>
                        <p className="text-sm text-blue-100 leading-relaxed">
                            Portal resmi Pemerintah Kalurahan Trimulyo yang menyediakan informasi dan layanan publik
                        ...
                        <div className="flex space-x-3">
                            {socialLinks.map((social) => (
                                <Link
                                    key={social.label}
                                    href={social.href}
                                    className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-white hover:bg-blue-100 transition-colors"
                                ...
                                <li key={link.href}>
                                    {link.external ? (
                                        <a
                                            ...
                                            className="text-sm text-blue-100 hover:text-accent transition-colors flex items-center"
                                        >
                            ...
                            {layananLinks.map((link) => (
                                <li key={link.href}>
                                    {link.external ? (
                                        ...
                                        <Link
                                            href={link.href}
                                            className="text-sm text-blue-100 hover:text-accent transition-colors"
                                        >
                                            {link.label}
                                        </Link>
                                    )}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-sm text-blue-100">{t("footer.jamOperasional")}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4">
                            <div className="flex items-center space-x-2 text-xs sm:text-sm text-white/60">
                                ...
                                <span>for Trimulyo Smart Village</span>
                            </div>
                        </div>
                    </div>
                </div>
