...
interface IDMDataNotAvailableProps {
    year: number;
    onRetry?: () => void;
    className?: string;
}

export function IDMDataNotAvailable({ year, onRetry, className }: IDMDataNotAvailableProps) {
    return (
        <div className={cn("flex items-center justify-center py-12", className)}>
            <Card className="max-w-lg w-full border-2 border-dashed border-gray-200">
                <CardContent className="flex flex-col items-center justify-center py-12 px-8">
                    ...
                    <p className="text-sm text-gray-500 text-center mb-6 max-w-sm">
                        Silakan coba tahun lain atau coba lagi nanti.
                    </p>
